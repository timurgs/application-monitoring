# Generated by Django 4.1.2 on 2022-11-04 16:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_performed_type', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='security_events', to='backend.workperformedtype', verbose_name='Вид выполненных работ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('closing_result', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.closingresult', verbose_name='Результат закрытия')),
            ],
            options={
                'verbose_name': 'Отзыв',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='backend.address', verbose_name='Адрес')),
                ('defect', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='backend.defect', verbose_name='Дефект')),
                ('implementing_organization', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='backend.implementingorganization', verbose_name='Организация-исполнитель')),
                ('user', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='requests', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
                'verbose_name': 'Заявка',
        ...
        migrations.AddField(
            model_name='closingresult',
            name='marm_implementing_organization',
